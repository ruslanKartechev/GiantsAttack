...
namespace RaftsWar.UI
{
    public class MenuWin : MonoBehaviour, IMenuWin
    {
        ...
        private TowerProgressCalculator _towerProgressCalculator;
        ...
        public void Show(float addedTowerProgress, Action buttonCallback, Action onDone)
        {
            ...
            _towerProgressCalculator = new TowerProgressCalculator(addedTowerProgress, _towerProgUI, AllowButton);
            Show(onDone);
        }
