...
{
    public class SubStageExecutorJumpAttack : SubStageExecutorBasic
    {
        public SubStageExecutorJumpAttack(SubStage stage, IMonster enemy, IHelicopter player, IPlayerMover playerMover,
        ...
        {
            _enemy.AlignPositionToAnimRootBone(true);
            Complete();
        }
    }
}